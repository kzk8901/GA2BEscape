...
void CSceneMain::InitScene()
{
	...
	Draw::LoadImageW(L"主人公.png", 4, TEX_SIZE_128);
	Draw::LoadImageW(L"image3.png", 3, TEX_SIZE_64);
	Draw::LoadImageW(L"whitewindow.png", 5, TEX_SIZE_1024);
	Draw::LoadImageW(L"きらら.png", 50, TEX_SIZE_128);
	Draw::LoadImageW(L"奏多.png", 51, TEX_SIZE_128);
	Draw::LoadImageW(L"永遠.png", 52, TEX_SIZE_128);
	...
	Draw::LoadImageW(L"heroMT.png", 53, TEX_SIZE_256);
